...
export const allUpdates = [
	...
	},
	{
		...
		type: "bug",
		description: "Algumas formatações de campos de texto foram feitas. Usuários estavam conseguindo postar publicações com quebras de linhas e espaços infinitos.",
		version: "1.2.3",
		date: "31/07/2022"
	},
	{
		...
		type: "new",
		description: "Agora a partir da versão 1.1, o usuário consegue curtir e descurtir os posts de sua preferência a partir do clique no ícone de coração em cada publicação.",
		version: "1.2.2",
		date: "31/07/2022"
	},
	{
		...
		type: "warning",
		description: "Todas as publicações foram resetadas, pois a Dev Social Network migrou seu banco de dados.",
		version: "1.2.1",
		date: "31/07/2022"
	},
	{
	...
	},
	{
		...
		type: "bug",
		description: "Quando o usuário realizava uma publicação, todas as publicações dele se agrupavam e bagunçavam a ordenação dos posts no feed.",
		version: "1.1.3",
		date: "29/07/2022"
	},
	{
	...
	},
	{
		...
		type: "new",
		description: "Nas stacks do perfil do usuário foram adicionadas novas stacks: Redux, Prisma, Git, MongoDB e NestJS.",
		version: "1.1.1",
		date: "29/07/2022"
	},
]