    ...
    return (
        ...
        <div className={styles.mainContainer}>
            <div className={styles.logoContainer}>
                ...
                <img src={"https://piauihoje.com/uploads/imagens/tecno-divulgacao-1654806461.jpeg"} alt="Imagem de Fundo" />
            </div>
            ...
            <div className={styles.registerContainer}>
                ...
                {isBoolean === false ?
                    <form className={styles.form1} onSubmit={handleContinue}>
                        ...
                        <Input label="Confirmar senha" itsPassword value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} />
                        <button className={styles.buttonToHandleContinue} type="submit">Continuar</button>
                    </form>
                    :
                    <form className={styles.form2} onSubmit={handleRegister}>
                        <Input label="Localidade da empresa" value={companyLocation} onChange={(e) => setCompanyLocation(e.target.value)} />
                        
                        <label>
                            Quantidade de funcionários
                            <select value={numberOfEmplooyees} onChange={(e) => setNumberOfEmplooyees(e.target.value)}>
                                <option>1-10</option>
                                <option>11-50</option>
                        ...
                        <button className={styles.buttonToHandleRegister} type="submit">Cadastrar</button>
