  ...
  return (
    <div className={styles.mainContainer}>
      <div className={styles.logoContainer}>
        ...
        <img
          src="https://fia.com.br/wp-content/uploads/2022/06/tecnologia-na-saude-principais-avancos-tendencias-aplicad.jpg"
          alt=""
        />
      </div>
      ...
      <div className={styles.selectActionContainer}>
        ...
        <p className={styles.policy}>
          Ao registrar, você concorda com os <span>termos e condições da nossa política</span>.
        </p>
      </div>
    </div>
  );
